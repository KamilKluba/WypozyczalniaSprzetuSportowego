...
public class CreateModel
{
	...
	private void initComponents() {
		...
		textFieldSeasonOfUse.setBounds(200, 190, 150, 30);
		...
		buttonCreateModel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(dialogCreateModel, "Pole nazwa modelu nie moze byc puste"); 
					...
					for(Model m : mainWindow.getArrayListModels())
						if(Integer.toString(m.getModelID()).equals(modelID)){
				...
				mainWindow.getArrayListModels().add(new Model(modelID2,
